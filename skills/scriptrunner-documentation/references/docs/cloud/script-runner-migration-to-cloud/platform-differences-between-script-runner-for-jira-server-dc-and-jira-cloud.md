...
- Doc ID: doc-sr4jc-2004bf70-9bf4-46a7-bf31-ed329d447316-64d97c49a9c3b537
- Source: https://docs.adaptavist.com/sr4jc/latest/scriptrunner-migration-to-cloud/platform-differences-between-scriptrunner-for-jira-serverdc-and-jira-cloud
...
Scripts in Jira Cloud do not execute within the same process as Jira Server and so must interact with Jira using the [REST APIs](../get-started/technical-background.md) rather than the JAVA APIs.
