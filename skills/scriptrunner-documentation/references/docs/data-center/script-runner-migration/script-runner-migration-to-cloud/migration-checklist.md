...
- Doc ID: doc-sr4js-5c6b812b-ef7d-4732-bfcd-96560848ef16-18d152b6a2555221
- Source: https://docs.adaptavist.com/sr4js/latest/scriptrunner-migration/scriptrunner-migration-to-cloud/migration-checklist
...
3.  Identify any ScriptRunner queries that do not have equivalent Enhanced Search functions. These are the filters you will have to rewrite.
    ...
    -   [JQL Functions Feature Parity](https://docs.adaptavist.com/sr4js/latest/scriptrunner-migration/scriptrunner-migration-to-cloud/feature-parity-and-script-alternatives#jql-functions--en)
    ...
    -   [Enhanced Search Training](../../../cloud/training/course-script-runner-for-jira-cloud-for-beginners/1-4-module-enhanced-search.md)
...
1.  Check the [migration report](https://docs.adaptavist.com/sr4js/latest/scriptrunner-migration/scriptrunner-migration-to-cloud/troubleshoot-scriptrunner-migration#troubleshoot-scriptrunner-migration-migration-reports--en) in ScriptRunner for Jira Cloud to find the details of any problems during filter migration.
...
3.  Manually update ScriptRunner for Jira Cloud as described in the [Manually migrate ScriptRunner](https://docs.adaptavist.com/sr4js/latest/scriptrunner-migration/scriptrunner-migration-to-cloud/migration-checklist#manually-migrate-scriptrunner--en) section.
...
-   Make sure they're familiar with the new ScriptRunner for Jira Cloud interface and capabilities. To get them started, refer your admins to our [ScriptRunner for Jira Cloud training](../../../cloud/uncategorized/t/training.md) documentation.
-   Highlight the differences in [scripting in ScriptRunner for Jira Cloud](../../../cloud/get-started/scripting-in-script-runner-for-jira-cloud.md).
